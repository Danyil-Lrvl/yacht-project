...
* **Оренда та Покупка:** Роздільні життєві цикли та таблиці для орендних угод (`rents`) та процедур купівлі-продажу (`prodazha_yachts`).Інтерактивний календар для перевірки вільних/зайнятих дат для конкретної яхти при операції оренди.
